...
start_mm() {
  ...
  opensips)
    ...
    MM_PID=${!}
    ALICE_ARGS="-46"
#    (sleep 5; sudo ${BUILDDIR}/dist/opensips/scripts/opensipsctl trap)&
    (sleep 10; sudo ${BUILDDIR}/dist/opensips/scripts/opensipsctl trap)&
#    (sleep 15; sudo ${BUILDDIR}/dist/opensips/scripts/opensipsctl trap)&
    ;;
